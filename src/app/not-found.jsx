...
export default function NotFound() {
  ...
  useGSAP(
    () => {
      ...
      linesTl.to('.line-container', { yPercent: 20 });
  ...
  return (
    <div className="relative" ref={container}>
      <div className="line-container absolute inset-0 -z-1 size-full overflow-hidden">
        ...
        <div className="absolute top-1/2 left-[180%] -z-1 flex size-[400%] -translate-1/2 items-center justify-center opacity-15 md:left-[180%] lg:pt-16">
      ...
      <div className="container flex h-[calc(100vh-72px)] items-center justify-center lg:h-screen">
        <div className="flex grow flex-col gap-12 text-center">
          <div className="space-y-8">
            <h1
              id="title"
              className="font-secondary text-6xl leading-snug whitespace-pre-wrap sm:text-7xl lg:text-8xl"
            >
              صفحه مورد نظر <br className="hidden min-[350px]:block lg:hidden" />
              <span className="text-primary">یافت نشد</span>
            </h1>

            <p className="text-paragraph mx-auto max-w-95 leading-relaxed md:max-w-none">
              گاهی حتی روشن‌ترین مسیرها هم به یک پیچ اشتباه می‌رسند. بیایید دوباره مسیر درست را پیدا
              کنیم.
            </p>
          </div>
