    ...
    <div className="space-y-20 lg:space-y-30">
      <div className="relative">
        ...
        <div className="container flex items-center">
          <div className="flex flex-col gap-10 pt-12.5 lg:gap-16 lg:pt-20">
            <div className="flex flex-col gap-6 lg:flex-row-reverse lg:items-center lg:justify-between">
              <h4 className="text-primary text-3xl font-bold">سارا</h4>
              <h2 className="font-secondary max-w-105 text-7xl leading-snug whitespace-pre-wrap text-black md:max-w-170 md:text-8xl">
                مسیر درمان
              </h2>
            </div>
            <h5 className="text-2xl leading-relaxed whitespace-pre-wrap text-black lg:flex">
              <span className="hidden lg:inline-block lg:w-[23%]"></span>
              <p className="lg:w-[78%]">
                <span className="inline-block w-[15%]"></span> لورم ایپسوم متن ساختگی با تولید سادگی
      ...
      <div className="container space-y-20 md:space-y-22">
        {clientSteps.slice(0, 2).map((step) => (
