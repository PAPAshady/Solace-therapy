...
export default function Quote() {
  ...
  return (
    <div
      ref={container}
      className="relative flex min-h-[90vh] items-center justify-center overflow-hidden bg-[#fafafa] lg:h-[115vh]"
    >
      ...
      <div className="absolute top-[calc(50%-1030px)] right-[calc(70%-340px)] hidden h-[2000px] w-170 lg:block">
        <div className="size-full">
          ...
          >
            <path
              ...
              fill="transparent"
              id="line1"
              className="[stroke-dashoffset:3300px] [@media(min-height:850px)]:[stroke-dashoffset:3400px]"
              style={{ strokeDasharray: 12843.3 }}
            ></path>
          </svg>
        </div>
      </div>
      <div className="absolute top-[calc(50%-1030px)] right-[calc(70%-340px)] hidden h-[2000px] w-170 lg:block">
        <div className="size-full">
          <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 680 2000">
            <path
