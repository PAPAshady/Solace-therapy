...
export default function BlogContent({ client }) {
  ...
  useGSAP(
    () => {
      ...
      linesTl.to('.line-container', { yPercent: -15, opacity: 0, duration: 0.3 });
  ...
  return (
    <div className="relative container" ref={container}>
      <div className="line-container fixed inset-0 -z-1 hidden size-full overflow-hidden md:block">
        <div className="absolute top-1/2 left-[180%] flex size-[400%] -translate-1/2 items-center justify-center opacity-20 md:left-[200%] lg:pt-16">
