      ...
      <div className="space-y-8">
        <div className="space-y-7.5 text-center">
          <div className="flex flex-col items-center gap-6">
            ...
            <p className="text-primary font-semibold">مقالات بیشتر</p>
          </div>
          <h2 className="text-[34px] leading-snug">
            مقالات مرتبط <span className="text-primary">سلامت روان</span>
          </h2>
          <p className="text-paragraph mx-auto max-w-120">
            مقاله‌ها، راهکارها و مطالب کاربردی بیشتری را برای حمایت از رشد فردی و سلامت روان خود
            دنبال کنید.
          </p>
        </div>
